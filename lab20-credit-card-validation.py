...
def ccv(number_string):
	...
	"""
	string_to_list = number_string.split(' ') # Convert the input string into a list of ints
	...
	reverse[::2] = [int(n)*2 for n in reverse[::2]] # Double every other element in the reversed list.
	minus_nine = []
	addition = 0
